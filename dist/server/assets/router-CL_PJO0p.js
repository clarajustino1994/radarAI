...
var Route$i = class Route extends BaseRoute {
  /**
...
const appCss = "/assets/styles-CgJ5KlIg.css";
const ACTIVITIES = [
  {
    id: "bunkers",
...
const PARTICIPANTS = [
  { id: "you", name: "You", color: "bg-primary", status: "Done", time: 22 },
  { id: "marc", name: "Marc", color: "bg-accent", status: "Done", time: 18 },
  { id: "júlia", name: "Júlia", color: "bg-emerald-500", status: "Filling", time: 0 },
  { id: "pau", name: "Pau", color: "bg-sky-500", status: "Not started", time: 0 }
];
const HISTORY = [
...
const PlanCtx = reactExports.createContext(null);
function PlanProvider({ children }) {
  const [plan, setPlan] = reactExports.useState(initial);
  const setName = (s) => setPlan((p) => ({ ...p, name: s }));
  const setLocation = (s) => setPlan((p) => ({ ...p, location: s }));
  const setInitialDistance = (s) => setPlan((p) => ({ ...p, initialDistance: s, prefs: { ...p.prefs, distance: s } }));
  const setPref = (k, v) => setPlan((p) => ({ ...p, prefs: { ...p.prefs, [k]: v } }));
  const setFlex = (k, v) => setPlan((p) => ({ ...p, prefs: { ...p.prefs, flex: { ...p.prefs.flex, [k]: v } } }));
  const vote = (id, dir) => setPlan((p) => {
  ...
  const confirm = (id) => setPlan((p) => ({ ...p, confirmedId: id }));
  const setRating = (n) => setPlan((p) => ({ ...p, rating: n }));
  const toggleTag = (t) => setPlan((p) => {
  ...
  const sendChat = (text) => setPlan((p) => ({ ...p, chat: [...p.chat, { id: p.chat.length + 1, from: "You", text, at: "now" }] }));
  const markChatRead = () => setPlan((p) => ({ ...p, chatUnread: 0 }));
  const rankedActivities = () => {
    const { prefs } = plan;
    const distMax = { "<1 km": 1, "1–5 km": 5, "5–15 km": 15, "15–30 km": 30 };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PlanCtx.Provider, { value: { plan, setName, setLocation, setInitialDistance, setPref, setFlex, vote, confirm, setRating, toggleTag, submit, sendChat, markChatRead, rankedActivities, reset }, children });
}
function usePlan() {
  const ctx = reactExports.useContext(PlanCtx);
...
const Route$h = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Radar AI — Outdoor plans for your group" },
      { name: "description", content: "Decide what to do outdoors in Barcelona, together. Tap-fast preference flow, ranked picks, vote, confirm." },
      { property: "og:title", content: "Radar AI" },
      { property: "og:description", content: "Outdoor plan decisions for friend groups in Spain." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&family=JetBrains+Mono:wght@400;500;700&display=swap" }
    ]
  }),
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PlanProvider, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster2, { position: "top-center" })
  ] }) });
}
const $$splitComponentImporter$g = () => import("./welcome-DDcM7mok.js");
const Route$g = createFileRoute("/welcome")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./summary-Cyc8duhu.js");
const Route$f = createFileRoute("/summary")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./results-CmbRLJTe.js");
const Route$e = createFileRoute("/results")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./prefs-BgQg9kQO.js");
const Route$d = createFileRoute("/prefs")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./no-match-CSSWwQDm.js");
const Route$c = createFileRoute("/no-match")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./lobby-DN5NjpXP.js");
const Route$b = createFileRoute("/lobby")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./join-BQGl1VA1.js");
const Route$a = createFileRoute("/join")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./invite-Ck47-koV.js");
const Route$9 = createFileRoute("/invite")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./history-d_MBoDDh.js");
const Route$8 = createFileRoute("/history")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./go-C2_Ga3w6.js");
const Route$7 = createFileRoute("/go")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./feedback-Szxn3pAH.js");
const Route$6 = createFileRoute("/feedback")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./create-Be4ph6mj.js");
const Route$5 = createFileRoute("/create")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./conflict-irOhadVB.js");
const Route$4 = createFileRoute("/conflict")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./compromise-Cpfgs6gY.js");
const Route$3 = createFileRoute("/compromise")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./chat-BJO-0eAa.js");
const Route$2 = createFileRoute("/chat")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./index-C_dELmBa.js");
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Plan outdoor and indoor outings in Spain with friends. Tap-fast preferences, ranked picks, vote, confirm — all in one app."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./activity._id-a-UIyG-j.js");
const Route2 = createFileRoute("/activity/$id")({
...
const SummaryRoute = Route$f.update({
  id: "/summary",
  path: "/summary",
  getParentRoute: () => Route$h
});
...
const PrefsRoute = Route$d.update({
  id: "/prefs",
  path: "/prefs",
  getParentRoute: () => Route$h
});
const NoMatchRoute = Route$c.update({
  id: "/no-match",
  path: "/no-match",
  getParentRoute: () => Route$h
});
const LobbyRoute = Route$b.update({
  id: "/lobby",
  path: "/lobby",
  getParentRoute: () => Route$h
});
...
const InviteRoute = Route$9.update({
  id: "/invite",
  path: "/invite",
  getParentRoute: () => Route$h
});
...
const GoRoute = Route$7.update({
  id: "/go",
  path: "/go",
  getParentRoute: () => Route$h
});
const FeedbackRoute = Route$6.update({
  id: "/feedback",
  path: "/feedback",
  getParentRoute: () => Route$h
});
...
const ConflictRoute = Route$4.update({
  id: "/conflict",
  path: "/conflict",
  getParentRoute: () => Route$h
});
const CompromiseRoute = Route$3.update({
  id: "/compromise",
  path: "/compromise",
  getParentRoute: () => Route$h
});
...
const ActivityIdRoute = Route2.update({
  id: "/activity/$id",
  path: "/activity/$id",
  getParentRoute: () => Route$h
});
